...
import abl.frd.qremit.converter.nafex.service.AlFardanDohaModelService;
...
//pdf data is given
@Controller
public class AlFardanDohaModelController {
    private final MyUserDetailsService myUserDetailsService;
    private final CommonService commonService;
    @Autowired
    AlFardanDohaModelService alFardanDohaModelService;
    @Autowired
    public AlFardanDohaModelController(MyUserDetailsService myUserDetailsService, CommonService commonService) {
        this.myUserDetailsService = myUserDetailsService;
        this.commonService = commonService;
    }
    @PostMapping("/alfardan_dohaUpload")
    public String uploadFile(@AuthenticationPrincipal MyUserDetails userDetails, @ModelAttribute("file") MultipartFile file, 
        ...
        if (CommonService.hasCSVFormat(file)) {
            if(!commonService.ifFileExist(file.getOriginalFilename())){
                try {
                    Map<String, Object> resp = alFardanDohaModelService.save(file, userId, exchangeCode, nrtaCode);
