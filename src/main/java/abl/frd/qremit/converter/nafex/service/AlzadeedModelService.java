...
import abl.frd.qremit.converter.nafex.repository.AlzadeedModelRepository;
...
public class AlzadeedModelService {
    ...
    public Map<String, Object> csvToAlzadeedModels(InputStream is, User user, FileInfoModel fileInfoModel, String exchangeCode, String nrtaCode) {
        ...
        try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
            ...
            List<AlzadeedModel> alzadeedDataModelList = new ArrayList<>();
            ...
            for (CSVRecord csvRecord : csvRecords) {
                ...
                duplicateData = alzadeedModelRepository.findByTransactionNoIgnoreCaseAndAmountAndExchangeCode(transactionNo, Double.valueOf(amount), exchangeCode);
                ...
                AlzadeedModel alzadeedDataModel = new AlzadeedModel();
                alzadeedDataModel = CommonService.createDataModel(alzadeedDataModel, data);
                alzadeedDataModel.setTypeFlag(CommonService.setTypeFlag(beneficiaryAccount, bankName, branchCode));
                alzadeedDataModel.setUploadDateTime(currentDateTime);
                alzadeedDataModelList.add(alzadeedDataModel);
            }
