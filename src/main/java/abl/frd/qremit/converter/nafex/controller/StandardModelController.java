...
import abl.frd.qremit.converter.nafex.service.StandardModelService;
...
public class StandardModelController {
    ...
    @Autowired
    public StandardModelController(StandardModelService standardModelService,MyUserDetailsService myUserDetailsService, CommonService commonService){
