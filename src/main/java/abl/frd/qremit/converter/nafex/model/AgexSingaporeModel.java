...
@Entity
@Table(name="base_data_table_singapore", uniqueConstraints = @UniqueConstraint(columnNames = {"file_info_model_id", "transaction_no"}))
public class AgexSingaporeModel {
    @Id
    @Column(name = "id")
