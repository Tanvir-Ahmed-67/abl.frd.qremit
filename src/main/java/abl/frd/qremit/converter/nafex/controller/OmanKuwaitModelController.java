...
import abl.frd.qremit.converter.nafex.service.OmanKuwaitModelService;
import java.util.*;

@Controller
public class OmanKuwaitModelController {
    private final MyUserDetailsService myUserDetailsService;
    private final OmanKuwaitModelService omanKuwaitModelService;
    private final CommonService commonService;
    
    @Autowired
    public OmanKuwaitModelController(OmanKuwaitModelService omanKuwaitModelService,MyUserDetailsService myUserDetailsService, CommonService commonService){
        this.myUserDetailsService = myUserDetailsService;
        this.omanKuwaitModelService = omanKuwaitModelService;
