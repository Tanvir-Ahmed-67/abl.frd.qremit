...
public class FsieModelService {
    ...
    public Map<String, Object> save(MultipartFile file, int userId, String exchangeCode, String nrtaCode) {
        ...
        try
        {
            ...
            Map<String, Object> fsieData = csvToFsieModels(file.getInputStream(), user, fileInfoModel, exchangeCode, nrtaCode);
    ...
    public Map<String, Object> csvToFsieModels(InputStream is, User user, FileInfoModel fileInfoModel, String exchangeCode, String nrtaCode){
        Map<String, Object> resp = new HashMap<>();
