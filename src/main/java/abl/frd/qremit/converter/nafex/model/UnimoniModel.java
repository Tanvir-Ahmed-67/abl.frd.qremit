...
@Entity
@Table(name="base_data_table_unimoni", uniqueConstraints = { @UniqueConstraint(columnNames = { "transaction_no", "amount", "exchange_code"})},
