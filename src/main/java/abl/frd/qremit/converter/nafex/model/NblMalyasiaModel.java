...
@Entity
@Table(name="base_data_table_nblmalyasia", uniqueConstraints = @UniqueConstraint(columnNames = {"file_info_model_id", "transaction_no"}))
public class NblMalyasiaModel {
    @Id
    @Column(name = "id")
