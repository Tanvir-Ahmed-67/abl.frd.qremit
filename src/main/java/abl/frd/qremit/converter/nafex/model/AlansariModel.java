...
@Entity
@Table(name="base_data_table_alansari", uniqueConstraints = { @UniqueConstraint(columnNames = { "transaction_no", "amount", "exchange_code"})})
public class AlansariModel {
    @Id
    @Column(name = "id")
