...
import abl.frd.qremit.converter.nafex.service.InstantCashModelService;
import java.util.*;

@Controller
public class InstantCashModelController {
    private final MyUserDetailsService myUserDetailsService;
    private final InstantCashModelService instantCashModelService;
    private final CommonService commonService;
    
    @Autowired
    public InstantCashModelController(InstantCashModelService instantCashModelService,MyUserDetailsService myUserDetailsService, CommonService commonService){
        this.myUserDetailsService = myUserDetailsService;
        this.instantCashModelService = instantCashModelService;
