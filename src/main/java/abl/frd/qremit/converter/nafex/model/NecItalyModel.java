...
@Entity
@Table(name="base_data_table_necitaly", uniqueConstraints = { @UniqueConstraint(columnNames = { "transaction_no", "amount", "exchange_code"})})
public class NecItalyModel {
    @Id
    @Column(name = "id")
