...
@Entity
@Table(name="base_data_table_albilad", uniqueConstraints = {@UniqueConstraint(columnNames = { "transaction_no", "amount", "exchange_code"})})
public class AlBiladModel {
    @Id
    @Column(name = "id")
