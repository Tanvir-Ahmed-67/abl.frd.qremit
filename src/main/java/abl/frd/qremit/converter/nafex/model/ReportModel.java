...
public class ReportModel {
    ...
    @Column(name = "report_from", columnDefinition = "DATE")
    private LocalDateTime reportFrom;
    @Column(name = "report_to", columnDefinition = "DATE")
    private LocalDateTime reportTo;
    ...
    public LocalDateTime getReportFrom() {
        return this.reportFrom;
    }

    public void setReportFrom(LocalDateTime reportFrom) {
        this.reportFrom = reportFrom;
    }

    public LocalDateTime getReportTo() {
        return this.reportTo;
    }

    public void setReportTo(LocalDateTime reportTo) {
