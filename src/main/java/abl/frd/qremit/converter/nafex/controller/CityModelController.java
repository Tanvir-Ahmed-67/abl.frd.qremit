...
import abl.frd.qremit.converter.nafex.service.CityModelService;
...
public class CityModelController {
    ...
    @Autowired
    public CityModelController(MyUserDetailsService myUserDetailsService, CommonService commonService) {
    ...
    public String uploadFile(@AuthenticationPrincipal MyUserDetails userDetails, @ModelAttribute("file") MultipartFile file, 
        ...
        if (CommonService.hasCSVFormat(file)) {
            if(!commonService.ifFileExist(file.getOriginalFilename())){
                try {
                    Map<String, Object> resp = cityModelService.save(file, userId, exchangeCode, nrtaCode);
