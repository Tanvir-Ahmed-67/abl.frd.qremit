...
import abl.frd.qremit.converter.nafex.repository.NecUkModelRepository;
...
public class NecUkModelService {
    ...
    public Map<String, Object> save(MultipartFile file, int userId, String exchangeCode, String nrtaCode) {
        ...
        try
        {
            ...
            Map<String, Object> necUkData = csvToNecUkModels(file.getInputStream(), user, fileInfoModel, exchangeCode, nrtaCode);
    ...
    public Map<String, Object> csvToNecUkModels(InputStream is, User user, FileInfoModel fileInfoModel, String exchangeCode, String nrtaCode) {
        Map<String, Object> resp = new HashMap<>();
        ...
        try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
            ...
            for (CSVRecord csvRecord : csvRecords) {
                ...
                duplicateData = necUkModelRepository.findByTransactionNoIgnoreCaseAndAmountAndExchangeCode(transactionNo, Double.valueOf(amount), exchangeCode);
