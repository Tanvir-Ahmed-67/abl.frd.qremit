...
import abl.frd.qremit.converter.nafex.service.AlRostamaniModelService;
...
@Controller
public class AlRostamaniModelController {
    ...
    public String uploadFile(@AuthenticationPrincipal MyUserDetails userDetails, @ModelAttribute("file") MultipartFile file, 
        ...
        if (CommonService.hasCSVFormat(file)) {
            if(!commonService.ifFileExist(file.getOriginalFilename())){
                try {
                    Map<String, Object> resp = alRostamaniModelService.save(file, userId, exchangeCode, nrtaCode);
