...
import abl.frd.qremit.converter.nafex.repository.IndexModelRepository;
    ...
    public Map<String, Object> csvToIndexModels(InputStream is, User user, FileInfoModel fileInfoModel, String exchangeCode, String nrtaCode){
        ...
        try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
            ...
            for (CSVRecord csvRecord : csvRecords) {
                ...
                duplicateData = indexModelRepository.findByTransactionNoIgnoreCaseAndAmountAndExchangeCode(transactionNo, CommonService.convertStringToDouble(amount), exchangeCode);
                ...
                indexModel = CommonService.createDataModel(indexModel, data);
                indexModel.setTypeFlag(CommonService.setTypeFlag(beneficiaryAccount, bankName, branchCode));
                indexModel.setUploadDateTime(currentDateTime);
