...
public class GenericModelService {
    ...
    public Map<String, Object> save(MultipartFile file, int userId, String exchangeCode, String nrtaCode) {
        ...
        try
        {
            ...
            Map<String, Object> genericData = csvToGenericModels(file.getInputStream(), user, fileInfoModel, exchangeCode, nrtaCode);
    ...
    public Map<String, Object> csvToGenericModels(InputStream is, User user, FileInfoModel fileInfoModel, String exchangeCode, String nrtaCode) {
        Map<String, Object> resp = new HashMap<>();
        ...
        try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
            ...
            for (CSVRecord csvRecord : csvRecords) {
                ...
                duplicateData = genericModelRepository.findByTransactionNoIgnoreCaseAndAmountAndExchangeCode(transactionNo, Double.valueOf(amount), exchangeCode);
