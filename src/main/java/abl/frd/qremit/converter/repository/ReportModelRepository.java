...
public interface ReportModelRepository  extends JpaRepository<ReportModel, Integer>{
    ...
    @Query("SELECT new abl.frd.qremit.converter.model.ExchangeReportDTO(n.exchangeCode, COUNT(n), SUM(n.amount)) " + "FROM ReportModel n WHERE n.reportDate = :reportDate and n.type in ('1','2','3','4')" + "GROUP BY n.exchangeCode")
