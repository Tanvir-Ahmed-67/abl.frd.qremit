...
@Entity
@Table(name="base_data_table_progoti", uniqueConstraints = { @UniqueConstraint(columnNames = { "transaction_no", "amount", "exchange_code"})},
    indexes = { @Index(name = "idx_file_info_model_id", columnList = "file_info_model_id") }
)
public class ProgotiModel {
    @Id
    @Column(name = "id")
