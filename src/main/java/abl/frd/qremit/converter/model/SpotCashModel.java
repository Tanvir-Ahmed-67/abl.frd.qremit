...
@Entity
@Table(name="base_data_table_spotcash", uniqueConstraints = { @UniqueConstraint(columnNames = { "transaction_no", "amount", "exchange_code"})},
...
public class SpotCashModel {
    ...
    public String getBeneficiaryNid() {
        return this.beneficiaryNid;
    }

    public void setBeneficiaryNid(String beneficiaryNid) {
        this.beneficiaryNid = beneficiaryNid;
    }

    public String getRemitterPassport() {
        return this.remitterPassport;
    }

    public void setRemitterPassport(String remitterPassport) {
        this.remitterPassport = remitterPassport;
    }
    ...
    public String toString() {
        return "{" +
            ...
            ", beneficiaryNid='" + getBeneficiaryNid() + "'" +
            ", remitterPassport='" + getRemitterPassport() + "'" +
