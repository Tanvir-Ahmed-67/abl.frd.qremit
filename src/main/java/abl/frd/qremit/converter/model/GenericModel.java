...
@Entity
@Table(name="base_data_table_generic", uniqueConstraints = { @UniqueConstraint(columnNames = { "transaction_no", "amount", "exchange_code"})},
