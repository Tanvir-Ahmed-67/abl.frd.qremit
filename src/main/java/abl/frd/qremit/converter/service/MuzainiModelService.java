...
import abl.frd.qremit.converter.model.MuzainiModel;
...
public class MuzainiModelService {
    ...
    public Map<String, Object> save(MultipartFile file, int userId, String exchangeCode, String nrtaCode, String tbl) {
        ...
        try
        {
            ...
            Map<String, Object> muzainiData = csvToMuzainiModels(file.getInputStream(), user, fileInfoModel, exchangeCode, nrtaCode, currentDateTime, tbl);
            ...
            if(muzainiData.containsKey("errorMessage")){
                resp.put("errorMessage", muzainiData.get("errorMessage"));
            }
            if(muzainiData.containsKey("errorCount") && ((Integer) muzainiData.get("errorCount") >= 1)){
                int errorCount = (Integer) muzainiData.get("errorCount");
            ...
            if(muzainiModels.size()!=0) {
                ...
                Map<String, Object> convertedDataModels = commonService.generateFourConvertedDataModel(muzainiModels, fileInfoModel, user, currentDateTime, 0);
    ...
    public Map<String, Object> csvToMuzainiModels(InputStream is, User user, FileInfoModel fileInfoModel, String exchangeCode, String nrtaCode, LocalDateTime currentDateTime, String tbl){
        Map<String, Object> resp = new HashMap<>();
        Optional<MuzainiModel> duplicateData = Optional.empty();
        try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
            ...
            modelResp = CommonService.processDataToModel(dataList, fileInfoModel, user, uniqueDataList, archiveDataList, currentDateTime, duplicateData, MuzainiModel.class, resp, errorDataModelList, fileExchangeCode, 0, 0);
            List<MuzainiModel> muzainiDataModelList = (List<MuzainiModel>) modelResp.get("modelList");
            ...
            if(errorDataModelList.isEmpty() && muzainiDataModelList.isEmpty()){
    ...
    public Map<String, Object> getCsvData(CSVRecord csvRecord, String exchangeCode, String transactionNo, String beneficiaryAccount, String bankName, String branchCode){
        ...
        data.put("remitterMobile", csvRecord.get(14));
        ...
        data.put("purposeOfRemittance", csvRecord.get(13));
