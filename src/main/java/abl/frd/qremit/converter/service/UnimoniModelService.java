...
import abl.frd.qremit.converter.repository.UnimoniModelRepository;
...
public class UnimoniModelService {
    ...
    public Map<String, Object> save(MultipartFile file, int userId, String exchangeCode, String nrtaCode, String tbl) {
        ...
        try
        {
            ...
            Map<String, Object> unimoniData = csvToUnimoniModels(file.getInputStream(), user, fileInfoModel, exchangeCode, nrtaCode, currentDateTime, tbl);
    ...
    public Map<String, Object> csvToUnimoniModels(InputStream is, User user, FileInfoModel fileInfoModel, String exchangeCode, String nrtaCode, LocalDateTime currentDateTime, String tbl) {
        Map<String, Object> resp = new HashMap<>();
        Optional<UnimoniModel> duplicateData = Optional.empty();
        try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
            ...
            modelResp = commonService.processDataToModel(dataList, fileInfoModel, user, uniqueDataList, archiveDataList, currentDateTime, duplicateData, UnimoniModel.class, resp, errorDataModelList, fileExchangeCode, 0, 0);
            List<UnimoniModel> unimoniDataModelList = (List<UnimoniModel>) modelResp.get("modelList");
    ...
    public Map<String, Object> getCsvData(CSVRecord csvRecord, String exchangeCode, String transactionNo, String beneficiaryAccount, String bankName, String branchCode){
        ...
        LocalDate date = CommonService.convertStringToLocalDate(csvRecord.get(4), "yyyyMMdd");
