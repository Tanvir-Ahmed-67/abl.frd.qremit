    ...
    public Map<String, Object> csvToRiaModels(InputStream is, int type, String exchangeCode, User user, FileInfoModel fileInfoModel, String nrtaCode, 
        ...
        try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
            ...
            if(isValidFile == 1){    
                ...
                modelResp = CommonService.processDataToModel(dataList, fileInfoModel, user, uniqueDataList, archiveDataList, currentDateTime, duplicateData, RiaModel.class, resp, fileExchangeCode, 1, type);
